...
namespace OpenUtau.Plugin.Builtin {
    [Phonemizer("Chinese VCV (樗儿式中文连续音) Phonemizer (Plugin)", "ZH VCV", language: "ZH")]
    public class ChineseVCVPhonemizerPlugin : Phonemizer {
        ...
        static ChineseVCVPhonemizerPlugin() {
